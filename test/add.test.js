...
describe("add", () => {
    ...
    it("adds positive integer number to negative integer number (decrease prices)", () => {
        expect(add(6, -3)).to.equal(3)
    });
    it("adds positive integer number to negative float number (decrease prices)", () => {
        expect(add(6, -3.56)).to.approximately(2.44, 0.001)
    });
    it("adds positive float number to negative integer number (decrease prices)", () => {
        expect(add(6.56, -3)).to.approximately(3.56, 0.001)
    });
    it("adds positive float number to negative float number (decrease prices)", () => {
